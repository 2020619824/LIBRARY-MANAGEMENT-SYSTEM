...
Partial Public Class User_dataSet
    ...
    Partial Public Class UserDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddUserRow(ByVal Staff_ID As String, ByVal Staff_Name As String, ByVal Phone_no As Decimal, ByVal Username As String, ByVal Password As String) As UserRow
            Dim rowUserRow As UserRow = CType(Me.NewRow,UserRow)
            Dim columnValuesArray() As Object = New Object() {Staff_ID, Staff_Name, Phone_no, Username, Password}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByStaff_ID(ByVal Staff_ID As String) As UserRow
    ...
    Partial Public Class UserRow
        ...
        Public Property Staff_ID() As String
            Get
                Return CType(Me(Me.tableUser.Staff_IDColumn),String)
            End Get
            Set
        ...
        Public Property Phone_no() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableUser.Phone_noColumn),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Phone_no' in table 'User' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableUser.Phone_noColumn) = value
            End Set
        End Property
        ...
        Public Function IsPhone_noNull() As Boolean
            Return Me.IsNull(Me.tableUser.Phone_noColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetPhone_noNull()
            Me(Me.tableUser.Phone_noColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace User_dataSetTableAdapters
    ...
    Partial Public Class UserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([Staff_ID] = @Original_Staff_ID) AND ([Staff_Nam"& _ 
                "e] = @Original_Staff_Name) AND ((@IsNull_Phone_no = 1 AND [Phone_no] IS NULL) OR"& _ 
                " ([Phone_no] = @Original_Phone_no)) AND ([Username] = @Original_Username) AND (["& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Phone_no", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 15, 0, "Phone_no", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([Staff_ID], [Staff_Name], [Phone_no], [Username], [Pass"& _ 
                "word]) VALUES (@Staff_ID, @Staff_Name, @Phone_no, @Username, @Password);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT"& _ 
                " Staff_ID, Staff_Name, Phone_no, Username, Password FROM [User] WHERE (Staff_ID "& _ 
                "= @Staff_ID)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Phone_no", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 15, 0, "Phone_no", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[User] SET [Staff_ID] = @Staff_ID, [Staff_Name] = @Staff_Name, [Phon"& _ 
                "e_no] = @Phone_no, [Username] = @Username, [Password] = @Password WHERE (([Staff"& _ 
                "_ID] = @Original_Staff_ID) AND ([Staff_Name] = @Original_Staff_Name) AND ((@IsNu"& _ 
                "ll_Phone_no = 1 AND [Phone_no] IS NULL) OR ([Phone_no] = @Original_Phone_no)) AN"& _ 
                "D ([Username] = @Original_Username) AND ([Password] = @Original_Password));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SEL"& _ 
                "ECT Staff_ID, Staff_Name, Phone_no, Username, Password FROM [User] WHERE (Staff_"& _ 
                "ID = @Staff_ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Phone_no", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 15, 0, "Phone_no", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Phone_no", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 15, 0, "Phone_no", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Staff_ID, Staff_Name, Phone_no, Username, Password FROM dbo.[User]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As User_dataSet.UserDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As User_dataSet.UserDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As User_dataSet.UserDataTable = New User_dataSet.UserDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As User_dataSet.UserDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Staff_ID As String, ByVal Original_Staff_Name As String, ByVal Original_Phone_no As Global.System.Nullable(Of Decimal), ByVal Original_Username As String, ByVal Original_Password As String) As Integer
            ...
            If (Original_Phone_no.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_Phone_no.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Staff_ID As String, ByVal Staff_Name As String, ByVal Phone_no As Global.System.Nullable(Of Decimal), ByVal Username As String, ByVal Password As String) As Integer
            ...
            If (Phone_no.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(Phone_no.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Staff_ID As String, ByVal Staff_Name As String, ByVal Phone_no As Global.System.Nullable(Of Decimal), ByVal Username As String, ByVal Password As String, ByVal Original_Staff_ID As String, ByVal Original_Staff_Name As String, ByVal Original_Phone_no As Global.System.Nullable(Of Decimal), ByVal Original_Username As String, ByVal Original_Password As String) As Integer
            If (Staff_ID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Staff_ID")
            Else
            ...
            End If
            If (Phone_no.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Phone_no.Value,Decimal)
            Else
            ...
            If (Original_Phone_no.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_Phone_no.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Staff_Name As String, ByVal Phone_no As Global.System.Nullable(Of Decimal), ByVal Username As String, ByVal Password As String, ByVal Original_Staff_ID As String, ByVal Original_Staff_Name As String, ByVal Original_Phone_no As Global.System.Nullable(Of Decimal), ByVal Original_Username As String, ByVal Original_Password As String) As Integer
            Return Me.Update(Original_Staff_ID, Staff_Name, Phone_no, Username, Password, Original_Staff_ID, Original_Staff_Name, Original_Phone_no, Original_Username, Original_Password)
        End Function
    End Class
